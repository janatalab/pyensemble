...
"""
This module was copied from a psychopy clone of commit 3a9f66c:
https://github.com/psychopy/psychopy/commit/3a9f66c58f6a3fbdf76f51a7f63109cafcd02614

It is intended to operate independently of psychopy.
"""
...
def setPortAddress(address=0x0378):
    ...
    try:
        ...
        logger.warning('Could not initiate port: %s' % str(exp))
        PORT = None
